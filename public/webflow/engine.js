...
(function () {
  ...
  Object.assign(LANDING_FALLBACK_TEXT, {
    ...
    de: {
      ...
      value3: "praktische, direkt nutzbare Hinweise für Eltern",
      value4: "gebrandeter PDF-Bericht per E-Mail",
      ...
      previewCaption: "Beispielvorschau: Der vollständige Bericht kommt personalisiert als PDF.",
      reasonTitle: "Warum lohnt es sich jetzt?",
      reasonBody: "Nach dem kurzen Fragebogen erhältst du nicht nur ein Etikett, sondern eine verständliche Richtung: worauf du zu Hause achten kannst, wann fachliche Unterstützung sinnvoll sein kann und welcher nächste Schritt hilft.",
      reasonParent: "Weniger Unsicherheit",
      reasonSchool: "Klareres Gespräch mit Kita oder Schule",
      reasonCalm: "Ein ruhigeres, geordneteres Bild",
      reasonNote: "Ziel ist nicht zu erschrecken, sondern Muster verständlich einzuordnen.",
      demoTitle: "Was klärt der vollständige Bericht?",
      demoLead: "Der PDF-Bericht erklärt Haupt- und Nebensignale, Alterskontext und praktische Empfehlungen gemeinsam.",
      demoMetric1: "Hauptmuster",
      demoMetric2: "Altersbezogener Kontext",
    ...
    it: {
      modalTitle: "Scegli la lingua",
      modalIntro: "Seleziona la lingua preferita.",
      heroTitle: "Capisci cosa può esserci dietro il comportamento di tuo figlio",
      heroSub: "Dopo un questionario di circa 10 minuti ricevi un report PDF personalizzato e chiaro per genitori.",
      primaryCta: "Inizia ->",
      microcopy: "Solo $5 - nessun abbonamento - report PDF via email",
      trust1: "circa 10 minuti",
      trust2: "report PDF via email",
      trust3: "analisi strutturata",
      valueTitle: "Cosa ricevi esattamente?",
      value1: "interpretazione personalizzata basata sulle risposte",
      value2: "pattern comportamentali, emotivi e di apprendimento evidenziati",
      value3: "suggerimenti pratici e subito utilizzabili dai genitori",
      value4: "report PDF brandizzato via email",
      stepsTitle: "Come funziona",
      step1: "1. Compili il breve questionario di screening",
      step2: "2. Il sistema seleziona il set di domande più rilevante",
      step3: "3. Dopo il pagamento, il report viene creato e inviato via email",
      previewTitle: "Come appare il report",
      previewCaption: "Anteprima di esempio: il report completo arriva personalizzato in PDF.",
      reasonTitle: "Perché compilarlo ora?",
      reasonBody: "Dopo il breve questionario non ricevi solo un'etichetta, ma una direzione comprensibile: cosa osservare a casa, quando può essere utile rivolgersi a uno specialista e quale passo successivo può aiutare.",
      reasonParent: "Meno incertezza",
      reasonSchool: "Dialogo più chiaro con scuola o asilo",
      reasonCalm: "Un quadro più calmo e ordinato",
      reasonNote: "L'obiettivo non è spaventare, ma organizzare i pattern in modo chiaro.",
      demoTitle: "Cosa chiarisce il report completo?",
      demoLead: "Il PDF spiega insieme segnali principali e secondari, contesto dell'età e suggerimenti pratici.",
      demoMetric1: "Pattern principale",
      demoMetric2: "Contesto per età",
      demoMetric3: "Prossimi passi",
      demoNote: "Il report è chiaro per i genitori, strutturato e non diagnostico.",
    ...
    es: {
      ...
      heroSub: "Tras un cuestionario de unos 10 minutos, recibes un informe PDF personalizado y claro para familias.",
      primaryCta: "Empezar ->",
      microcopy: "Solo $5 - sin suscripción - informe PDF por email",
      trust1: "unos 10 minutos",
      trust2: "informe PDF por email",
      trust3: "análisis estructurado",
      valueTitle: "¿Qué recibes exactamente?",
      ...
      value3: "sugerencias prácticas y utilizables por los padres",
      value4: "informe PDF con marca por email",
      stepsTitle: "Cómo funciona",
      step1: "1. Completa el breve cuestionario de cribado",
      step2: "2. El sistema selecciona el bloque de preguntas más relevante",
      step3: "3. Después del pago, el informe se genera y llega por email",
      ...
      reasonBody: "Después del breve cuestionario no recibes solo una etiqueta, sino una orientación clara: qué observar en casa, cuándo puede ser útil consultar a un especialista y cuál puede ser el siguiente paso.",
      reasonParent: "Menos incertidumbre",
      reasonSchool: "Mejor conversación con la escuela o preescolar",
      reasonCalm: "Una imagen más tranquila y ordenada",
      ...
      demoLead: "El PDF explica las señales principales y secundarias, el contexto de edad y las sugerencias prácticas.",
      demoMetric1: "Patrón principal",
      demoMetric2: "Contexto por edad",
    ...
    zh: {
      modalTitle: "选择语言",
      modalIntro: "请选择你的首选语言。",
      heroTitle: "了解孩子行为背后可能的原因",
      heroSub: "完成约 10 分钟问卷后，你将收到一份个性化、家长友好的 PDF 报告。",
      primaryCta: "开始 ->",
      microcopy: "仅 $5 - 无订阅 - PDF 报告发送至邮箱",
      trust1: "约 10 分钟",
      trust2: "PDF 报告邮件发送",
      trust3: "结构化分析",
      valueTitle: "你会得到什么？",
      ...
      value2: "突出行为、情绪和学习模式",
      value3: "家长可直接使用的实用建议",
      value4: "品牌化 PDF 报告发送至邮箱",
      stepsTitle: "流程说明",
      step1: "1. 完成简短的初筛问卷",
      step2: "2. 系统选择最相关的详细问题组",
      step3: "3. 付款后生成报告并发送到邮箱",
      previewTitle: "报告预览",
      previewCaption: "示例预览：完整报告将以个性化 PDF 形式发送。",
      reasonTitle: "为什么现在填写？",
      reasonBody: "简短问卷后，你得到的不只是一个标签，而是更清晰的方向：在家观察什么、何时考虑寻求专业建议，以及下一步可以怎么做。",
      reasonParent: "减少不确定感",
      reasonSchool: "更好地与幼儿园或学校沟通",
      reasonCalm: "更清晰、更安心的图景",
      reasonNote: "目标不是制造焦虑，而是用易懂的方式整理模式。",
      demoTitle: "完整报告会说明什么？",
      demoLead: "完整 PDF 会综合说明主要和次要信号、年龄背景以及实用建议。",
      demoMetric1: "主要模式",
      demoMetric2: "年龄相关背景",
      demoMetric3: "下一步",
      demoNote: "报告面向家长，结构清晰，不作诊断。",
      trustTitle: "重要说明",
      trustText: "NeuroMap Kids 不是诊断，而是结构化初筛。",
      priceTitle: "一次性付款",
      priceValue: "仅 $5",
      priceCta: "获取报告 ->",
      priceMicrocopy: "无订阅 - 安全支付 - PDF 邮件发送",
      stickyCta: "开始 ->"
    },
    ja: {
      modalTitle: "言語を選択",
      modalIntro: "希望する言語を選択してください。",
      ...
      value3: "保護者がすぐ使える実践的な提案",
      value4: "ブランド付きPDFレポートをメールで送付",
      stepsTitle: "流れ",
      step1: "1. 短いスクリーニング質問票に回答",
      step2: "2. システムが関連性の高い詳細質問を選択",
      step3: "3. 支払い後、レポートが作成されメールで届きます",
      previewTitle: "レポートの見え方",
      previewCaption: "サンプル表示：完全版は個別PDFとして届きます。",
      reasonTitle: "なぜ今回答する価値があるのか",
      reasonBody: "短い質問票のあと、単なるラベルではなく、家庭で何を見るか、専門家に相談するタイミング、次の一歩を考えるための方向性が得られます。",
      reasonParent: "不安を減らす",
      ...
      demoLead: "PDFでは、主なサインと副次的なサイン、年齢に応じた背景、実践的な提案をまとめて説明します。",
      demoMetric1: "主なパターン",
      demoMetric2: "年齢に応じた視点",
      demoMetric3: "次のステップ",
      demoNote: "レポートは保護者向けで、構造化されており、診断ではありません。",
      trustTitle: "大切なお知らせ",
      trustText: "NeuroMap Kids は診断ではなく、構造化されたスクリーニングです。",
      priceTitle: "一回払い",
      priceValue: "わずか $5",
      priceCta: "レポートを受け取る ->",
    ...
    pl: {
      ...
      heroSub: "Po około 10-minutowym kwestionariuszu otrzymasz spersonalizowany, przyjazny rodzicom raport PDF.",
      primaryCta: "Zacznij ->",
      microcopy: "Tylko $5 - bez abonamentu - raport PDF emailem",
      trust1: "ok. 10 minut",
      trust2: "raport PDF emailem",
      trust3: "analiza strukturalna",
      valueTitle: "Co dokładnie otrzymasz?",
      value1: "spersonalizowaną interpretację na podstawie odpowiedzi",
      value2: "wyróżnione wzorce zachowania, emocji i uczenia się",
      value3: "praktyczne wskazówki gotowe do użycia przez rodzica",
      value4: "brandowany raport PDF emailem",
      stepsTitle: "Jak to działa",
      step1: "1. Wypełniasz krótki kwestionariusz przesiewowy",
      step2: "2. System wybiera odpowiedni szczegółowy zestaw pytań",
      step3: "3. Po płatności raport jest generowany i wysyłany emailem",
      previewTitle: "Jak wygląda raport",
      previewCaption: "Przykładowy podgląd: pełny raport przychodzi jako spersonalizowany PDF.",
      reasonTitle: "Dlaczego warto wypełnić teraz?",
      reasonBody: "Po krótkim kwestionariuszu otrzymujesz nie tylko etykietę, ale zrozumiały kierunek: co obserwować w domu, kiedy warto skonsultować się ze specjalistą i jaki kolejny krok może pomóc.",
      reasonParent: "Mniej niepewności",
      reasonSchool: "Łatwiejsza rozmowa z przedszkolem lub szkołą",
      reasonCalm: "Spokojniejszy, uporządkowany obraz",
      reasonNote: "Celem nie jest straszenie, ale zrozumiałe uporządkowanie wzorców.",
      demoTitle: "Co wyjaśnia pełny raport?",
      demoLead: "Pełny PDF wyjaśnia główne i dodatkowe sygnały, kontekst wieku oraz praktyczne sugestie.",
      demoMetric1: "Główny wzorzec",
      demoMetric2: "Kontekst wieku",
      demoMetric3: "Następne kroki",
      demoNote: "Raport jest przyjazny rodzicom, uporządkowany i niediagnostyczny.",
      trustTitle: "Ważne",
      trustText: "NeuroMap Kids nie jest diagnozą, lecz strukturalnym badaniem przesiewowym.",
    ...
    pt: {
      modalTitle: "Escolher idioma",
      modalIntro: "Selecione o idioma de preferência.",
      heroTitle: "Entenda o que pode estar por trás do comportamento do seu filho",
      heroSub: "Após um questionário de cerca de 10 minutos, você recebe um relatório PDF personalizado e claro para pais.",
      primaryCta: "Começar ->",
      microcopy: "Apenas $5 - sem assinatura - relatório PDF por email",
      trust1: "cerca de 10 minutos",
      trust2: "relatório PDF por email",
      trust3: "análise estruturada",
      valueTitle: "O que você recebe exatamente?",
      ...
      value3: "sugestões práticas para os pais usarem imediatamente",
      value4: "relatório PDF com identidade NeuroMap Kids por email",
      stepsTitle: "Como funciona",
      step1: "1. Você preenche o breve questionário de triagem",
      step2: "2. O sistema seleciona o conjunto específico de perguntas mais relevante",
      step3: "3. Após o pagamento, o relatório é gerado e enviado por email",
      previewTitle: "Como o relatório se parece",
      previewCaption: "Prévia de exemplo: o relatório completo chega personalizado em PDF.",
      reasonTitle: "Por que preencher agora?",
      reasonBody: "Após o breve questionário, você não recebe apenas um rótulo, mas uma direção compreensível: o que observar em casa, quando pode ser útil procurar orientação profissional e qual próximo passo pode ajudar.",
      reasonParent: "Menos incerteza",
      reasonSchool: "Conversa mais clara com a escola ou pré-escola",
      reasonCalm: "Uma visão mais calma e organizada",
      ...
      demoLead: "O PDF explica sinais principais e secundários, contexto de idade e sugestões práticas em conjunto.",
      demoMetric1: "Padrão principal",
      demoMetric2: "Contexto por idade",
      demoMetric3: "Próximos passos",
      demoNote: "O relatório é amigável para pais, estruturado e não diagnóstico.",
      trustTitle: "Importante saber",
      trustText: "NeuroMap Kids não é um diagnóstico, mas uma triagem estruturada.",
    ...
    fr: {
      modalTitle: "Choisir la langue",
      modalIntro: "Sélectionnez votre langue préférée.",
      heroTitle: "Comprendre ce qui peut se cacher derrière le comportement de votre enfant",
      heroSub: "Après un questionnaire d’environ 10 minutes, vous recevez un rapport PDF personnalisé et clair pour les parents.",
      primaryCta: "Commencer ->",
      microcopy: "Seulement $5 - sans abonnement - rapport PDF par email",
      trust1: "environ 10 minutes",
      trust2: "rapport PDF par email",
      trust3: "analyse structurée",
      valueTitle: "Que recevez-vous exactement ?",
      value1: "une interprétation personnalisée basée sur vos réponses",
      value2: "les schémas comportementaux, émotionnels et d’apprentissage mis en évidence",
      value3: "des suggestions pratiques utilisables par les parents",
      value4: "un rapport PDF NeuroMap Kids envoyé par email",
      stepsTitle: "Comment ça fonctionne",
      step1: "1. Vous remplissez le court questionnaire de dépistage",
      step2: "2. Le système sélectionne le questionnaire détaillé le plus pertinent",
      step3: "3. Après le paiement, le rapport est généré et envoyé par email",
      previewTitle: "À quoi ressemble le rapport",
      previewCaption: "Aperçu d’exemple : le rapport complet arrive en PDF personnalisé.",
      reasonTitle: "Pourquoi le remplir maintenant ?",
      reasonBody: "Après le court questionnaire, vous ne recevez pas seulement une étiquette, mais une orientation claire : quoi observer à la maison, quand demander un avis professionnel et quelle prochaine étape peut aider.",
      reasonParent: "Moins d’incertitude",
      reasonSchool: "Un dialogue plus clair avec l’école ou la crèche",
      reasonCalm: "Une vision plus calme et organisée",
      reasonNote: "Le but n’est pas d’inquiéter, mais d’organiser les schémas de manière compréhensible.",
      demoTitle: "Que clarifie le rapport complet ?",
      demoLead: "Le PDF explique ensemble les signaux principaux et secondaires, le contexte d’âge et les suggestions pratiques.",
      demoMetric1: "Schéma principal",
      demoMetric2: "Contexte d’âge",
      demoMetric3: "Prochaines étapes",
      demoNote: "Le rapport est structuré, adapté aux parents et non diagnostique.",
      trustTitle: "Important à savoir",
      trustText: "NeuroMap Kids n’est pas un diagnostic, mais un dépistage structuré.",
      priceTitle: "Paiement unique",
