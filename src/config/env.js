...
export const env = {
  ...
  RESEND_WEBHOOK_SECRET: optional('RESEND_WEBHOOK_SECRET', null),
  TAX_CONFIGURATION_APPROVED: optionalBoolean('TAX_CONFIGURATION_APPROVED', false),
  TAX_CONFIGURATION_EVIDENCE: optional('TAX_CONFIGURATION_EVIDENCE', null),
  INVOICE_TAX_POLICY_JSON: optional('INVOICE_TAX_POLICY_JSON', null),
  PAYMENT_REVIEW_OWNER: optional('PAYMENT_REVIEW_OWNER', null),
