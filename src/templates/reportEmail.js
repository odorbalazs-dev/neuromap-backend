...
export function buildReportEmail({ lang, name, reportText }) {
  ...
  const introMap = {
    hu: `Kedves Szülő! Elkészült ${escapeHtml(name || "a gyermek")} kérdőíves kiértékelése.`,
    en: `Dear Parent, the questionnaire-based report for ${escapeHtml(name || "your child")} is ready.`
  };
