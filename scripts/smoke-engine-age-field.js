...
function main() {
  ...
  assert(
    loaderHtml.includes("20260603-landing-rescue-v2"),
  ...
  assert(script.includes("20260603-landing-rescue-v2"), "Engine should expose the current landing rescue version.");
