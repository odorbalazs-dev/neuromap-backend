...
function main() {
  ...
  assert(
    loaderHtml.includes("20260613-cx-i18n-polish-v1"),
  ...
  assert(script.includes("20260613-cx-i18n-polish-v1"), "Engine should expose the current questionnaire shell version.");
  ...
  assert(script.includes("font-size: clamp(30px, 2.4vw, 40px)"), "Engine should include compact desktop hero sizing.");
