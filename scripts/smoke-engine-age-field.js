...
function main() {
  ...
  assert(
    loaderHtml.includes("20260605-pdf-summary-fix-v1"),
  ...
  assert(script.includes("20260605-pdf-summary-fix-v1"), "Engine should expose the current summary fix version.");
