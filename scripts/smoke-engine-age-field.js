...
function main() {
  ...
  assert(
    loaderHtml.includes("20260603-landing-rescue-v4"),
  ...
  assert(script.includes("20260603-landing-rescue-v4"), "Engine should expose the current landing rescue version.");
