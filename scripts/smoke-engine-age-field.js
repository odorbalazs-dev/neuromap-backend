...
function main() {
  ...
  assert(
    loaderHtml.includes("20260604-cx-top10-v2"),
  ...
  assert(script.includes("20260604-cx-top10-v2"), "Engine should expose the current customer experience top 10 version.");
