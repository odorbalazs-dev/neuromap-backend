...
function main() {
  ...
  assert(
    loaderHtml.includes("20260603-landing-rescue-v3"),
  ...
  assert(script.includes("20260603-landing-rescue-v3"), "Engine should expose the current landing rescue version.");
