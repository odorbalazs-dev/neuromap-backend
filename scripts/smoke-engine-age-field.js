...
function main() {
  ...
  assert(
    loaderHtml.includes("20260605-cx-complete-v3"),
  ...
  assert(script.includes("20260605-cx-complete-v3"), "Engine should expose the current customer experience version.");
